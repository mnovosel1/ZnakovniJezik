...
[Dirs]
Name: "{app}\img"; Permissions: users-full

[Files]
Source: "Release\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "*.pdb, ZnakovniJezik.bmp, ZnakovniJezik.ico, img\*"
